...
class TestAreaDistortion:
    ...
    def test_uniform_scaling(self):
        ...
        vertices = np.array([[0, 0, 0], [2, 0, 0], [0, 2, 0]], dtype=np.float64)
...
class TestUVCoverage:
    ...
    def test_full_coverage(self):
        ...
        uvs = np.array([[0, 0], [1, 0], [0, 1], [1, 1]], dtype=np.float64)
    ...
    def test_half_coverage(self):
        ...
        assert 40 < coverage < 60, f"Triangle should cover ~50%, got {coverage:.1f}%"
    ...
    def test_small_coverage(self):
        ...
        # Small UV triangle
        uvs = np.array([[0, 0], [0.1, 0], [0, 0.1]], dtype=np.float64)
